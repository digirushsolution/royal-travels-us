...
class Query extends Control_Select2 {
	...
	public function enqueue() {
		// script.
		wp_register_script( 'lke-ajaxchoose-control', MYTRAVEL_ELEMENTOR_MODULES_URL . 'query-control/assets/js/ajaxchoose.js', array(), MYTRAVEL_ELEMENTOR_VERSION, true );
		wp_enqueue_script( 'lke-ajaxchoose-control' );
	}
