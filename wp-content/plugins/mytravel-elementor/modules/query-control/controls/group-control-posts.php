...
class Group_Control_Posts extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['post_type'] = [
			'label' => __( 'Source', 'mytravel-elementor' ),
		...
		$fields['authors'] = [
			'label'       => __( 'Author', 'mytravel-elementor' ),
			'label_block' => true,
			'type'        => Module::QUERY_CONTROL_ID,
			'multiple'    => true,
			'default'     => [],
	...
	protected function prepare_fields( $fields ) {
		...
		$post_types_options['by_id']         = __( 'Manual Selection', 'mytravel-elementor' );
		$post_types_options['current_query'] = __( 'Current Query', 'mytravel-elementor' );
	...
	public function get_query_args( $control_id_prefix, $settings ) {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters( 'mytravel_elementor/query_control/get_query_args/current_query', $current_query_vars );
