...
/**
 * Product Style v5 Skin class.
 */
class Skin_Products_Style_5 extends Skin_Product_Base {
	/**
	...
	public function get_title() {
		return esc_html__( 'Car Rental', 'mytravel-elementor' );
	}
	...
	public function render() {
		...
		while ( $wp_query->have_posts() ) {
			...
			wc_get_template_part( 'content', 'car-rental' );
		}
