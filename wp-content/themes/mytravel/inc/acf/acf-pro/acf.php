...
if ( ! class_exists( 'ACF' ) ) {
	...
	class ACF {
		...
		public function initialize() {
			...
			// Define settings.
			$this->settings = array(
				'name'                    => __( 'Advanced Custom Fields', 'mytravel' ),
		...
		public function register_post_types() {
			...
			register_post_type(
				...
				array(
					'labels'          => array(
						'name'               => __( 'Field Groups', 'mytravel' ),
						'singular_name'      => __( 'Field Group', 'mytravel' ),
						'add_new'            => __( 'Add New', 'mytravel' ),
						'add_new_item'       => __( 'Add New Field Group', 'mytravel' ),
						'edit_item'          => __( 'Edit Field Group', 'mytravel' ),
						'new_item'           => __( 'New Field Group', 'mytravel' ),
						'view_item'          => __( 'View Field Group', 'mytravel' ),
						'search_items'       => __( 'Search Field Groups', 'mytravel' ),
						'not_found'          => __( 'No Field Groups found', 'mytravel' ),
						'not_found_in_trash' => __( 'No Field Groups found in Trash', 'mytravel' ),
					),
					'public'          => false,
					'hierarchical'    => true,
					'show_ui'         => true,
			...
			register_post_type(
				...
				array(
					'labels'          => array(
						'name'               => __( 'Fields', 'mytravel' ),
						'singular_name'      => __( 'Field', 'mytravel' ),
						'add_new'            => __( 'Add New', 'mytravel' ),
						'add_new_item'       => __( 'Add New Field', 'mytravel' ),
						'edit_item'          => __( 'Edit Field', 'mytravel' ),
						'new_item'           => __( 'New Field', 'mytravel' ),
						'view_item'          => __( 'View Field', 'mytravel' ),
						'search_items'       => __( 'Search Fields', 'mytravel' ),
						'not_found'          => __( 'No Fields found', 'mytravel' ),
						'not_found_in_trash' => __( 'No Fields found in Trash', 'mytravel' ),
					),
					'public'          => false,
					'hierarchical'    => true,
					'show_ui'         => false,
		...
		public function register_post_status() {
			...
			register_post_status(
				'acf-disabled',
				array(
					'label'                     => _x( 'Inactive', 'post status', 'mytravel' ),
					'public'                    => true,
					'exclude_from_search'       => false,
					'show_in_admin_all_list'    => true,
					'show_in_admin_status_list' => true,
					/* translators: counts for inactive field groups */
					'label_count'               => _n_noop( 'Inactive <span class="count">(%s)</span>', 'Inactive <span class="count">(%s)</span>', 'mytravel' ),
				)
			);
		}
		...
		public function plugin_deactivated_notice() {
			...
			$message = __( "Advanced Custom Fields and Advanced Custom Fields PRO should not be active at the same time. We've automatically deactivated Advanced Custom Fields.", 'mytravel' );
			if ( 2 === $deactivated_notice_id ) {
				$message = __( "Advanced Custom Fields and Advanced Custom Fields PRO should not be active at the same time. We've automatically deactivated Advanced Custom Fields PRO.", 'mytravel' );
			}
