		...
		function __construct() {
			...
			$this->fields = array(
				...
				'_validate_email' => array(
					...
					'key'     => '_validate_email',
					'label'   => __( 'Validate Email', 'mytravel' ),
					'type'    => 'text',
					'value'   => '',
		...
		function validate_form( $args ) {
			...
			$args = wp_parse_args(
				...
				array(
					...
					'html_before_fields'    => '',
					'html_after_fields'     => '',
					'submit_value'          => __( 'Update', 'mytravel' ),
					'updated_message'       => __( 'Post updated', 'mytravel' ),
					'label_placement'       => 'top',
		...
		*/
		...
		function validate_save_post() {
			...
			if ( ! empty( $_POST['acf']['_validate_email'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Missing -- Data not used; presence indicates spam.
				...
				acf_add_validation_error( '', __( 'Spam Detected', 'mytravel' ) );
			}
		}
