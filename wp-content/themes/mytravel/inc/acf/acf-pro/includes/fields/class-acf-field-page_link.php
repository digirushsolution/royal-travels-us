	...
	class acf_field_page_link extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			// vars
			$this->name          = 'page_link';
			$this->label         = __( 'Page Link', 'mytravel' );
			$this->category      = 'relational';
			$this->description   = __( 'An interactive dropdown to select one or more posts, pages, custom post type items or archive URLs, with the option to search.', 'mytravel' );
		...
		*/
		function render_field_settings( $field ) {
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Allow Archives URLs', 'mytravel' ),
					'instructions' => '',
					'name'         => 'allow_archives',
					'type'         => 'true_false',
					'ui'           => 1,
