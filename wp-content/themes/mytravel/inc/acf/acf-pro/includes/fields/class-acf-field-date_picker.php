	...
	class acf_field_date_picker extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			$this->label         = __( 'Date Picker', 'mytravel' );
			$this->category      = 'advanced';
			$this->description   = __( 'An interactive UI for picking a date. The date return format can be customized using the field settings.', 'mytravel' );
			...
			acf_localize_data(
				array(
					'datePickerL10n' => array(
						'closeText'       => _x( 'Done', 'Date Picker JS closeText', 'mytravel' ),
						'currentText'     => _x( 'Today', 'Date Picker JS currentText', 'mytravel' ),
						'nextText'        => _x( 'Next', 'Date Picker JS nextText', 'mytravel' ),
						'prevText'        => _x( 'Prev', 'Date Picker JS prevText', 'mytravel' ),
						'weekHeader'      => _x( 'Wk', 'Date Picker JS weekHeader', 'mytravel' ),
		...
		function render_field_settings( $field ) {
			...
			if ( ! empty( $field['save_format'] ) ) {
				acf_render_field_setting(
					$field,
					array(
						'label' => __( 'Save Format', 'mytravel' ),
						'hint'  => __( 'The format used when saving a value', 'mytravel' ),
						'type'  => 'text',
						'name'  => 'save_format',
