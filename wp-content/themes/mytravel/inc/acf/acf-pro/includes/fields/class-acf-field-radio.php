	...
	class acf_field_radio extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			// vars
			$this->name          = 'radio';
			$this->label         = __( 'Radio Button', 'mytravel' );
			$this->category      = 'choice';
			$this->description   = __( 'A group of radio button inputs that allows the user to make a single selection from values that you specify.', 'mytravel' );
		...
		*/
		...
		function render_field_validation_settings( $field ) {
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Allow Other Choice', 'mytravel' ),
					'name'         => 'other_choice',
					'type'         => 'true_false',
					'ui'           => 1,
					'instructions' => __( "Add 'other' choice to allow for custom values", 'mytravel' ),
				)
			);
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Save Other Choice', 'mytravel' ),
					'name'         => 'save_other_choice',
					'type'         => 'true_false',
					'ui'           => 1,
					'instructions' => __( "Save 'other' values to the field's choices", 'mytravel' ),
					'conditions'   => array(
						'field'    => 'other_choice',
						'operator' => '==',
						'value'    => 1,
