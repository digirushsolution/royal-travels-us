	...
	class acf_field_time_picker extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			$this->label         = __( 'Time Picker', 'mytravel' );
			$this->category      = 'advanced';
			$this->description   = __( 'An interactive UI for picking a time. The time format can be customized using the field settings.', 'mytravel' );
