	...
	class acf_field_file extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			// vars
			$this->name          = 'file';
			$this->label         = __( 'File', 'mytravel' );
			$this->category      = 'content';
			$this->description   = __( 'Uses the native WordPress media picker to upload, or choose files.', 'mytravel' );
		...
		*/
		...
		function input_admin_enqueue_scripts() {
			...
			acf_localize_text(
				array(
					'Select File' => __( 'Select File', 'mytravel' ),
					'Edit File'   => __( 'Edit File', 'mytravel' ),
					'Update File' => __( 'Update File', 'mytravel' ),
				)
			);
		}
...
<div <?php echo acf_esc_attrs( $div ); ?>>
	...
	<div class="show-if-value file-wrap">
		...
		<div class="file-info">
			...
			<p>
				<strong><?php _e( 'File name', 'mytravel' ); ?>:</strong>
				<a data-name="filename" href="<?php echo esc_url( $o['url'] ); ?>" target="_blank"><?php echo esc_html( $o['filename'] ); ?></a>
			</p>
			<p>
				<strong><?php _e( 'File size', 'mytravel' ); ?>:</strong>
				<span data-name="filesize"><?php echo esc_html( $o['filesize'] ); ?></span>
			</p>
		</div>
		<div class="acf-actions -hover">
			<?php if ( $uploader != 'basic' ) : ?>
			<a class="acf-icon -pencil dark" data-name="edit" href="#" title="<?php _e( 'Edit', 'mytravel' ); ?>"></a>
			<?php endif; ?>
			<a class="acf-icon -cancel dark" data-name="remove" href="#" title="<?php _e( 'Remove', 'mytravel' ); ?>"></a>
		</div>
	</div>
	<div class="hide-if-value">
		...
		<?php else : ?>
			...
			<p><?php _e( 'No file selected', 'mytravel' ); ?> <a data-name="add" class="acf-button button" href="#"><?php _e( 'Add File', 'mytravel' ); ?></a></p>
		...
		function render_field_settings( $field ) {
			acf_render_field_setting(
				...
				array(
					...
					'layout'       => 'horizontal',
					'choices'      => array(
						'array' => __( 'File Array', 'mytravel' ),
						'url'   => __( 'File URL', 'mytravel' ),
						'id'    => __( 'File ID', 'mytravel' ),
					),
				)
			);
		...
		function render_field_validation_settings( $field ) {
			...
			acf_render_field_setting(
				...
				array(
					...
					'instructions' => __( 'Restrict which files can be uploaded', 'mytravel' ),
					'type'         => 'text',
					'name'         => 'min_size',
		...
		*/
		...
		public function validate_rest_value( $valid, $value, $field ) {
			...
			if ( ! $attachment ) {
				$error = sprintf( __( '%s requires a valid attachment ID.', 'mytravel' ), $param );
