...
if ( ! class_exists( 'acf_field_button_group' ) ) :
	...
	class acf_field_button_group extends acf_field {
		...
		function initialize() {
			...
			$this->label         = __( 'Button Group', 'mytravel' );
			$this->category      = 'choice';
			$this->description   = __( 'A group of buttons with values that you specify, users can choose one option from the values provided.', 'mytravel' );
