	...
	class acf_field_link extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			// vars
			$this->name          = 'link';
			$this->label         = __( 'Link', 'mytravel' );
			$this->category      = 'relational';
			$this->description   = __( 'Allows you to specify a link and its properties such as title and target using the WordPress native link picker.', 'mytravel' );
...
<div <?php echo acf_esc_attrs( $div ); ?>>
	...
	<a href="#" class="button" data-name="add" target=""><?php _e( 'Select Link', 'mytravel' ); ?></a>
	...
	<div class="link-wrap">
		...
		<i class="acf-icon -link-ext acf-js-tooltip" title="<?php _e( 'Opens in a new window/tab', 'mytravel' ); ?>"></i><a class="acf-icon -pencil -clear acf-js-tooltip" data-name="edit" href="#" title="<?php _e( 'Edit', 'mytravel' ); ?>"></a><a class="acf-icon -cancel -clear acf-js-tooltip" data-name="remove" href="#" title="<?php _e( 'Remove', 'mytravel' ); ?>"></a>
	</div>
		...
		function render_field_settings( $field ) {
			acf_render_field_setting(
				...
				array(
					...
					'layout'       => 'horizontal',
					'choices'      => array(
						'array' => __( 'Link Array', 'mytravel' ),
						'url'   => __( 'Link URL', 'mytravel' ),
					),
				)
			);
		}
