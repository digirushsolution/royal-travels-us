...
if ( ! class_exists( 'acf_field_url' ) ) :
	...
	class acf_field_url extends acf_field {
		...
		public function initialize() {
			// vars
			$this->name          = 'url';
			$this->label         = __( 'URL', 'mytravel' );
			$this->description   = __( 'A text input specifically designed for storing web addresses.', 'mytravel' );
		...
		public function validate_value( $valid, $value, $field, $input ) {
			...
			if ( strpos( $value, '://' ) !== false ) {
				...
				$valid = __( 'Value must be a valid URL', 'mytravel' );
			}
