	...
	class acf_field_range extends acf_field_number {
		...
		*/
		...
		function initialize() {
			...
			// vars
			$this->name          = 'range';
			$this->label         = __( 'Range', 'mytravel' );
			$this->description   = __( 'An input for selecting a numerical value within a specified range using a range slider element.', 'mytravel' );
