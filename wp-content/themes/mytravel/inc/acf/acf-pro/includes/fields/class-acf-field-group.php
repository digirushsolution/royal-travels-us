	...
	class acf_field__group extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			// vars
			$this->name          = 'group';
			$this->label         = __( 'Group', 'mytravel' );
			$this->category      = 'layout';
			$this->description   = __( 'Provides a way to structure fields into groups to better organize the data and the edit screen.', 'mytravel' );
