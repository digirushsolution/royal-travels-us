	...
	class acf_field_oembed extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			// vars
			$this->name          = 'oembed';
			$this->label         = __( 'oEmbed', 'mytravel' );
			$this->category      = 'content';
			$this->description   = __( 'An interactive component for embedding videos, images, tweets, audio and other content by making use of the native WordPress oEmbed functionality.', 'mytravel' );
		...
		*/
		...
		function render_field( $field ) {
			...
			// <strong><?php _e("Error.", 'mytravel'); </strong> _e("No embed found for the given URL.", 'mytravel');
	...
	<div class="title">
			...
			acf_text_input(
				array(
					'class'        => 'input-search',
					'value'        => $field['value'],
					'placeholder'  => __( 'Enter URL', 'mytravel' ),
					'autocomplete' => 'off',
				)
			);
			?>
