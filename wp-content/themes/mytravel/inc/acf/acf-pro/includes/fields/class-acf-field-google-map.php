	...
	class acf_field_google_map extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			$this->label          = __( 'Google Map', 'mytravel' );
			$this->category       = 'advanced';
			$this->description    = __( 'An interactive UI for selecting a location using Google Maps. Requires a Google Maps API key and additional configuration to display correctly.', 'mytravel' );
		...
		*/
		...
		function input_admin_enqueue_scripts() {
			...
			acf_localize_text(
				array(
					'Sorry, this browser does not support geolocation'  => __( 'Sorry, this browser does not support geolocation', 'mytravel' ),
				)
			);
...
<div <?php echo acf_esc_attrs( $attrs ); ?>>
	...
	<div class="title">
		...
		<div class="acf-actions -hover">
			<a href="#" data-name="search" class="acf-icon -search grey" title="<?php _e( 'Search', 'mytravel' ); ?>"></a>
			<a href="#" data-name="clear" class="acf-icon -cancel grey" title="<?php _e( 'Clear location', 'mytravel' ); ?>"></a>
			<a href="#" data-name="locate" class="acf-icon -location grey" title="<?php _e( 'Find current location', 'mytravel' ); ?>"></a>
		</div>
		
		<input class="search" type="text" placeholder="<?php _e( 'Search for address...', 'mytravel' ); ?>" value="<?php echo esc_attr( $search ); ?>" />
		...
		*/
		...
		function render_field_settings( $field ) {
			...
			acf_render_field_setting(
				$field,
				array(
					'label'       => __( 'Center', 'mytravel' ),
					'hint'        => __( 'Center the initial map', 'mytravel' ),
					'type'        => 'text',
					'name'        => 'center_lat',
					'prepend'     => 'lat',
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Zoom', 'mytravel' ),
					'instructions' => __( 'Set the initial zoom level', 'mytravel' ),
					'type'         => 'text',
					'name'         => 'zoom',
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Height', 'mytravel' ),
					'instructions' => __( 'Customize the map height', 'mytravel' ),
					'type'         => 'text',
					'name'         => 'height',
					'append'       => 'px',
