	...
	class acf_field_email extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			// vars
			$this->name          = 'email';
			$this->label         = __( 'Email', 'mytravel' );
			$this->description   = __( 'A text input specifically designed for storing email addresses.', 'mytravel' );
		...
		*/
		...
		public function validate_value( $valid, $value, $field, $input ) {
			...
			if ( $value && filter_var( wp_unslash( $value ), FILTER_VALIDATE_EMAIL, $flags ) === false ) {
				return sprintf( __( "'%s' is not a valid email address", 'mytravel' ), esc_html( $value ) );
			}
