	...
	class acf_field_date_and_time_picker extends acf_field {
		...
		*/
		...
		function initialize() {
			...
			$this->label         = __( 'Date Time Picker', 'mytravel' );
			$this->category      = 'advanced';
			$this->description   = __( 'An interactive UI for picking a date and time. The date return format can be customized using the field settings.', 'mytravel' );
			...
			acf_localize_data(
				array(
					'dateTimePickerL10n' => array(
						'timeOnlyTitle' => _x( 'Choose Time', 'Date Time Picker JS timeOnlyTitle', 'mytravel' ),
						'timeText'      => _x( 'Time', 'Date Time Picker JS timeText', 'mytravel' ),
						'hourText'      => _x( 'Hour', 'Date Time Picker JS hourText', 'mytravel' ),
						'minuteText'    => _x( 'Minute', 'Date Time Picker JS minuteText', 'mytravel' ),
						'secondText'    => _x( 'Second', 'Date Time Picker JS secondText', 'mytravel' ),
						'millisecText'  => _x( 'Millisecond', 'Date Time Picker JS millisecText', 'mytravel' ),
						'microsecText'  => _x( 'Microsecond', 'Date Time Picker JS microsecText', 'mytravel' ),
						'timezoneText'  => _x( 'Time Zone', 'Date Time Picker JS timezoneText', 'mytravel' ),
						'currentText'   => _x( 'Now', 'Date Time Picker JS currentText', 'mytravel' ),
						'closeText'     => _x( 'Done', 'Date Time Picker JS closeText', 'mytravel' ),
						'selectText'    => _x( 'Select', 'Date Time Picker JS selectText', 'mytravel' ),
						'amNames'       => array(
							_x( 'AM', 'Date Time Picker JS amText', 'mytravel' ),
							_x( 'A', 'Date Time Picker JS amTextShort', 'mytravel' ),
						),
						'pmNames'       => array(
							_x( 'PM', 'Date Time Picker JS pmText', 'mytravel' ),
							_x( 'P', 'Date Time Picker JS pmTextShort', 'mytravel' ),
						),
					),
				)
			);
		...
		*/
		function render_field_settings( $field ) {
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Display Format', 'mytravel' ),
					'hint'         => __( 'The format displayed when editing a post', 'mytravel' ),
					'type'         => 'radio',
					'name'         => 'display_format',
					'other_choice' => 1,
					'choices'      => array(
						...
						'other'        => '<span>' . __( 'Custom:', 'mytravel' ) . '</span>',
					),
				)
			);
			...
			acf_render_field_setting(
				...
				array(
					...
					'hint'         => __( 'The format returned via template functions', 'mytravel' ),
					'type'         => 'radio',
					'name'         => 'return_format',
					'other_choice' => 1,
					'choices'      => array(
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Week Starts On', 'mytravel' ),
					'instructions' => '',
					'type'         => 'select',
					'name'         => 'first_day',
