...
acf_render_field_wrap(
	array(
		...
		'placeholder' => __( 'Movies', 'mytravel' ),
		'type'        => 'text',
		'name'        => 'name',
		'key'         => 'name',
...
acf_render_field_wrap(
	array(
		'label'        => __( 'Post Type Key', 'mytravel' ),
		'instructions' => __( 'Lower case letters, underscores and dashes only, Max 20 characters.', 'mytravel' ),
		/* translators: example post type */
		'placeholder'  => __( 'movie', 'mytravel' ),
		'type'         => 'text',
		'name'         => 'post_type',
...
acf_render_field_wrap(
	array(
		...
		'label'        => __( 'Taxonomies', 'mytravel' ),
		'instructions' => __( 'Select existing taxonomies to classify items of the post type.', 'mytravel' ),
...
acf_render_field_wrap(
	array(
		...
		'instructions' => __( 'Visible on the frontend and in the admin dashboard.', 'mytravel' ),
		'ui'           => true,
		'default'      => 1,
	),
	'div'
...
acf_render_field_wrap(
	array(
		...
		'instructions' => __( 'Hierarchical post types can have descendants (like pages).', 'mytravel' ),
		'ui'           => true,
	),
	'div'
);
