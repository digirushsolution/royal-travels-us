...
acf_render_field_wrap(
	array(
		'label'       => __( 'Plural Label', 'mytravel' ),
		/* translators: example taxonomy */
		'placeholder' => __( 'Genres', 'mytravel' ),
		'type'        => 'text',
		'key'         => 'name',
		'name'        => 'name',
...
acf_render_field_wrap(
	array(
		'label'       => __( 'Singular Label', 'mytravel' ),
		/* translators: example taxonomy */
		'placeholder' => __( 'Genre', 'mytravel' ),
		'type'        => 'text',
		'key'         => 'singular_name',
		'name'        => 'singular_name',
...
acf_render_field_wrap(
	array(
		'label'        => __( 'Taxonomy Key', 'mytravel' ),
		'instructions' => __( 'Lower case letters, underscores and dashes only, Max 32 characters.', 'mytravel' ),
		/* translators: example taxonomy */
		'placeholder'  => __( 'genre', 'mytravel' ),
		'type'         => 'text',
		'key'          => 'taxonomy',
...
acf_render_field_wrap(
	array(
		...
		'ui'           => 1,
		'allow_null'   => 1,
		'instructions' => __( 'One or many post types that can be classified with this taxonomy.', 'mytravel' ),
	),
	'div',
	'field'
);
...
acf_render_field_wrap(
	array(
		...
		'label'        => __( 'Public', 'mytravel' ),
		'instructions' => __( 'Makes a taxonomy visible on the frontend and in the admin dashboard.', 'mytravel' ),
		'ui'           => true,
		'default'      => 1,
	)
);
...
acf_render_field_wrap(
	array(
		...
		'instructions' => __( 'Hierarchical taxonomies can have descendants (like categories).', 'mytravel' ),
		'ui'           => true,
	),
	'div'
);
...
acf_render_field_wrap(
	array(
		'label'        => __( 'Advanced Configuration', 'mytravel' ),
		'instructions' => __( 'I know what I\'m doing, show me all the options.', 'mytravel' ),
		'type'         => 'true_false',
