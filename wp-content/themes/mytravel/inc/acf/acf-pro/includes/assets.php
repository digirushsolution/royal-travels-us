		...
		public function enqueue_scripts() {
			...
			acf_localize_text(
				array(
					...
					// Tooltip
					'Are you sure?' => __( 'Are you sure?', 'mytravel' ),
					'Yes'           => __( 'Yes', 'mytravel' ),
					'No'            => __( 'No', 'mytravel' ),
					'Remove'        => __( 'Remove', 'mytravel' ),
					'Cancel'        => __( 'Cancel', 'mytravel' ),
				)
			);
			...
			if ( wp_script_is( 'acf-input' ) ) {
				acf_localize_text(
					array(
						...
						// Unload
						'The changes you made will be lost if you navigate away from this page' => __( 'The changes you made will be lost if you navigate away from this page', 'mytravel' ),

						// Validation
						'Validation successful'       => __( 'Validation successful', 'mytravel' ),
						'Validation failed'           => __( 'Validation failed', 'mytravel' ),
						'1 field requires attention'  => __( '1 field requires attention', 'mytravel' ),
						'%d fields require attention' => __( '%d fields require attention', 'mytravel' ),

						// Other
						'Edit field group'            => __( 'Edit field group', 'mytravel' ),
					)
				);
