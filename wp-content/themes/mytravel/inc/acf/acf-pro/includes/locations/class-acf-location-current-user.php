...
if ( ! class_exists( 'ACF_Location_Current_User' ) ) :
	...
	class ACF_Location_Current_User extends ACF_Location {
		...
		public function initialize() {
			...
			$this->label    = __( 'Current User', 'mytravel' );
			$this->category = 'user';
		}
		...
		public function get_values( $rule ) {
			return array(
				'logged_in'     => __( 'Logged in', 'mytravel' ),
				'viewing_front' => __( 'Viewing front end', 'mytravel' ),
				'viewing_back'  => __( 'Viewing back end', 'mytravel' ),
			);
		}
	}
