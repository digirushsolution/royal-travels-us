...
if ( ! class_exists( 'ACF_Location_Page_Type' ) ) :
	...
	class ACF_Location_Page_Type extends ACF_Location {
		...
		public function initialize() {
			$this->name           = 'page_type';
			$this->label          = __( 'Page Type', 'mytravel' );
			$this->category       = 'page';
		...
		public function get_values( $rule ) {
			return array(
				'front_page' => __( 'Front Page', 'mytravel' ),
				'posts_page' => __( 'Posts Page', 'mytravel' ),
				'top_level'  => __( 'Top Level Page (no parent)', 'mytravel' ),
				'parent'     => __( 'Parent Page (has children)', 'mytravel' ),
				'child'      => __( 'Child Page (has parent)', 'mytravel' ),
			);
		}
	}
