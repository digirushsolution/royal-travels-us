	...
	class ACF_Media {
		...
		public function enqueue_scripts() {
			if ( wp_script_is( 'acf-input' ) ) {
				acf_localize_text(
					array(
						'Select.verb'           => _x( 'Select', 'verb', 'mytravel' ),
						'Edit.verb'             => _x( 'Edit', 'verb', 'mytravel' ),
						'Update.verb'           => _x( 'Update', 'verb', 'mytravel' ),
						'Uploaded to this post' => __( 'Uploaded to this post', 'mytravel' ),
						'Expand Details'        => __( 'Expand Details', 'mytravel' ),
						'Collapse Details'      => __( 'Collapse Details', 'mytravel' ),
						'Restricted'            => __( 'Restricted', 'mytravel' ),
