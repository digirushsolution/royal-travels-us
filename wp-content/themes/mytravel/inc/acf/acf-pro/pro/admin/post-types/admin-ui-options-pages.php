...
if ( ! class_exists( 'ACF_Admin_UI_Options_Pages' ) ) :
	...
	class ACF_Admin_UI_Options_Pages extends ACF_Admin_Internal_Post_Type_List {
		...
		public function admin_menu() {
			...
			add_submenu_page( $parent_slug, __( 'Options Pages', 'mytravel' ), __( 'Options Pages', 'mytravel' ), $cap, 'edit.php?post_type=acf-ui-options-page' );
		}
			...
			switch ( $action ) {
				case 'acfactivatecomplete':
					$text = sprintf(
						...
						_n( 'Options page activated.', '%s options pages activated.', $count, 'mytravel' ),
						$count
					);
					break;
				case 'acfdeactivatecomplete':
					$text = sprintf(
						...
						_n( 'Options page deactivated.', '%s options pages deactivated.', $count, 'mytravel' ),
						$count
					);
					break;
				case 'acfduplicatecomplete':
					$text = sprintf(
						...
						_n( 'Options page duplicated.', '%s options pages duplicated.', $count, 'mytravel' ),
						$count
					);
					break;
				case 'acfsynccomplete':
					$text = sprintf(
						...
						_n( 'Options page synchronized.', '%s options pages synchronized.', $count, 'mytravel' ),
						$count
					);
					break;
			}
