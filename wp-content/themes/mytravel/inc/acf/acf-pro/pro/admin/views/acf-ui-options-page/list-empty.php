...
<div class="acf-no-options-pages-wrapper">
	<div class="acf-no-options-pages-inner">
		...
		<h2><?php esc_html_e( 'Add Your First Options Page', 'mytravel' ); ?></h2>
		<p><?php echo acf_esc_html( $acf_options_pages_desc ); ?></p>
		<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=acf-ui-options-page' ) ); ?>" class="acf-btn"><i class="acf-icon acf-icon-plus"></i> <?php esc_html_e( 'Add Options Page', 'mytravel' ); ?></a>
